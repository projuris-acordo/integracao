...
|nomeUsuario|Sim|Alfanumérico (250)|O nome do usuário que está solicitando a criação/envio do lote de processos para ser negociado. Este nome será utilizado para identificar a empresa na participação de "Réu" no Sistema JUSTTO para realizar a criação de mensagens automatizadas|
